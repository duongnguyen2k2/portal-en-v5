...
namespace API.Areas.Admin.Controllers
{
    ...
    {
        private string controllerName = "ProductsOCOPController";
        private string controllerSecret;
        public ProductsOCOPController(IConfiguration config)
        {
        ...
        public IActionResult SaveItem(string Id = null)
        {
            ...
            else
            {
                ...
                //data.Item.CatMultiId = ProductsService.GetListCatIdByProductId(IdDC);
            }
        ...
        public ActionResult SaveItem(Products model)
        {
            ...
            if (ModelState.IsValid)
            {
                if (model.Id == IdDC)
                {
                    ...
                    if (model.CatId != null && model.CatMultiId.Count() > 0)
                    {
