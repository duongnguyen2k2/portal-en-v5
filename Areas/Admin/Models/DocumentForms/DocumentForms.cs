...
namespace API.Areas.Admin.Models.DocumentForms
{
    ...
    {
        public List<DocumentForms> ListItems { get; set; } = new List<DocumentForms>();
        public SearchDocumentForms SearchData { get; set; } = new SearchDocumentForms() { };
        public DocumentForms Item { get; set; } = new DocumentForms() { };
