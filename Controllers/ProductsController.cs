...
namespace API.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public IActionResult ListItems(string alias, int id, [FromQuery] SearchProducts dto)
        {
            int TotalItems = 0;
            ...
            data.CategoriesItem = CategoriesProductsService.GetItem(id);
            data.ListItems = ProductsService.GetListPagination(data.SearchData, API.Models.Settings.SecretId + ControllerName, 0);
            data.ListItemsCategories = CategoriesProductsService.GetListItems();
            data.ListDMCoQuan = DMCoQuanService.GetListByLoaiCoQuan(0, 0, IdCoQuan, false);
