...
namespace API.Models.ManagerFiles
{
    public class MIMETypesService
    {
        ...
        {
            List<String> listMIMETypes = new List<string>() { ".jpeg", ".jpg",".png", ".gif", ".webp" };
        ...
        {
            List<String> listMIMETypes = new List<string>() { ".csv", ".doc", ".docx", ".pdf", ".ppt", ".pptx", ".jpeg", ".jpg", ".png", ".gif",".webp",".mp3",".wav",".mp4",".xls" ,".xlsx"};
            return listMIMETypes;
        }
    }
}