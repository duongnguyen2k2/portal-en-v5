...
var vmArticles = new Vue({
    ...
    data: {
        ...
        SearchItems: { CurrentPage: 1, ItemsPerPage: 30, Keyword: '', TotalItems: 0, PageCount: 0, Status: 1, CatId: 0, IdCoQuan: 1 },
    ...
    methods: {
        ...
        getListJson: function () {
            ...
            $.ajax({
                type: "POST",
                url: '/Admin/ArticlesTransfer/IndexNew',
                ...
                success: resul => {
                    ...
                    if (resul.Success) {
                        ...
                        this.ListItems = resul.Data.ListItems;
        ...
        openItemDetails: function (id) {
            ...
            return $.ajax({
                type: "GET",
                url: '/Admin/ArticlesTransfer/GetDetailTinBaiLienThong?id=' + id,
                headers: this.headers,
        ...
        saveItem: function () {
            ...
            return $.ajax({
                type: "POST",
                url: '/Admin/ArticlesTransfer/LayTinBai',
                headers: this.headers,
