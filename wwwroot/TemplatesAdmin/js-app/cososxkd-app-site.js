...
var vmCoSoSXKD = new Vue({
    el: '#app-cososxkd',
    data: {
        title: "Tìm kiếm Nguồn gốc cây trồng",       
        SearchItems: { CurrentPage: 1, ItemsPerPage: 20, IdPhuongXa: 0, IdQuanHuyen:0, IdTinhThanh:42, Keyword: '', TotalItems: 0, PageCount:0 ,Status:-1},
        flagLoading: false,
    ...
    mounted() {
        document.getElementById("app-cososxkd").style.display = "block";
